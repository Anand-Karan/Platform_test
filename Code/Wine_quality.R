...
## Converting Target variable to categorical (1,0)
...
## As we can see in the image, the train set will contain fewer observations than the test set. 
## However, the train set will be balanced to train the models efficiently.
#Logistic Regression
...
roc_obj <- roc(test_set$quality, prob_pred)
roc_coords <- coords(roc_obj, "best")
#optCutOff <- roc_coords[1]  # Optimal cutoff point based on the best sensitivity and specificity
